...
const run = async () => {
  ...
  const workersData = [
    { name: 'Karim Sheikh', email: 'karim.electrician@workforce.app', phone: '+8801222222222', avatar: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?auto=format&fit=crop&w=400&q=80', service_type: 'Electrician', experience: '5-8 years', rating: 4.8, ratingCount: 34, bio: 'Licensed electrician specializing in residential wiring & emergency repairs.', isVerified: true, skills: ['Wiring', 'Fan Installation', 'Panel Repair'], completedJobs: 128, location: 'Faridpur, Dhaka Division', service: 'Electrician', hourly_rate: 350 },
    { name: 'Nasrin Akter', email: 'nasrin.painter@workforce.app', phone: '+8801333333333', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80', service_type: 'Painter', experience: '3-5 years', rating: 4.6, ratingCount: 21, bio: 'Detail-oriented painter for interior and exterior projects.', isVerified: true, skills: ['Interior Paint', 'Texture Wall', 'Waterproofing'], completedJobs: 76, location: 'Dhaka', service: 'Painter', fixed_price: 4500 },
    { name: 'Jahangir Alam', email: 'jahangir.plumber@workforce.app', phone: '+8801444444444', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80', service_type: 'Plumber', experience: '8+ years', rating: 4.9, ratingCount: 58, bio: 'Master plumber, 8+ years fixing leaks and installing fixtures fast.', isVerified: true, skills: ['Leak Repair', 'Pipe Fitting'], completedJobs: 210, location: 'Faridpur, Dhaka Division', service: 'Plumber', hourly_rate: 300 },
    { name: 'Salma Begum', email: 'salma.gardener@workforce.app', phone: '+8801555555555', avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=400&q=80', service_type: 'Gardener', experience: '2-4 years', rating: 4.5, ratingCount: 15, bio: 'Passionate gardener helping homes bloom, big or small.', isVerified: false, skills: ['Lawn Care', 'Planting'], completedJobs: 42, location: 'Gazipur', service: 'Gardener', hourly_rate: 200 },
    { name: 'Rafiq Islam', email: 'rafiq.carpenter@workforce.app', phone: '+8801666666666', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=80', service_type: 'Carpenter', experience: '5-8 years', rating: 4.7, ratingCount: 29, bio: 'Custom furniture and quick fix-it carpentry services.', isVerified: true, skills: ['Furniture', 'Door Repair'], completedJobs: 95, location: 'Faridpur, Dhaka Division', service: 'Carpenter', fixed_price: 2500 },
    { name: 'Moushumi Rani', email: 'moushumi.cleaner@workforce.app', phone: '+8801777777777', avatar: 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?auto=format&fit=crop&w=400&q=80', service_type: 'Cleaner', experience: '1-3 years', rating: 4.4, ratingCount: 12, bio: 'Reliable and thorough home cleaning, on your schedule.', isVerified: false, skills: ['Deep Clean', 'Move-out Clean'], completedJobs: 33, location: 'Dhaka', service: 'Cleaner', hourly_rate: 250 },
  ];
